...
public class Nonogram extends Observable {
    private ArrayList<NGPattern> copyRowNGPatterns = new ArrayList<>();
    private ArrayList<NGPattern> copyColNGPatterns = new ArrayList<>();
    /**
   ...
   * see https://github.com/mikix/nonogram-db/blob/master/FORMAT.md
    ...
    public ArrayList<NGPattern> rowPatReturn(){
        return copyRowNGPatterns;
    }
    
    public ArrayList<NGPattern> colPatReturn(){
        return copyColNGPatterns;
    }
