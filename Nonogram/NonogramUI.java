...
public class NonogramUI {
    ...
    public ArrayList<NGPattern> rowPatReturn(){
        return puzzle.rowPatReturn();
    }
    
    public ArrayList<NGPattern> colPatReturn(){
        return puzzle.colPatReturn();
    }
    
    /**
     * Make a move
     */
  public void move(Assign userMove) {
  ...
  public void load(){
      ...
      clear();
      while (fs.hasNextInt()) {
        Assign a = new Assign(fs.nextInt(), fs.nextInt(), fs.nextInt());
        puzzle.setState(a);
        stack.push(a);
      }
      fs.close();
  ...
  public Stack<Assign> stackReturn(){
      return stack;
  } 
